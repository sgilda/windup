...
Rules Metadata:: Information about whether a particular Ruleset applies to a given scenario. The metadata can include information about the source and target platform and frameworks.
